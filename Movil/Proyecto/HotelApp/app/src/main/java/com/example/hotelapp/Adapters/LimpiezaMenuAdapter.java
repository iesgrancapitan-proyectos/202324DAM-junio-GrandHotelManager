...
import com.example.hotelapp.HabitacionesLimpieza;
...
/**
 * LimpiezaMenuAdapter es un adaptador personalizado para un RecyclerView que muestra una lista de opciones de menú.
 */
public class LimpiezaMenuAdapter extends RecyclerView.Adapter<LimpiezaMenuAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            if (menuOption.getTitle().equals("Habitaciones")) {
                Intent intent = new Intent(context, HabitacionesLimpieza.class);

...
import com.example.hotelapp.Habitaciones;
import com.example.hotelapp.Informacion;
import com.example.hotelapp.Objetos.MenuOption;
import com.example.hotelapp.R;
import com.example.hotelapp.Reservas;

import java.util.List;

/**
 * MainMenuAdapter es un adaptador personalizado para un RecyclerView que muestra una lista de opciones de menú.
 */
public class MainMenuAdapter extends RecyclerView.Adapter<MainMenuAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            if (menuOption.getTitle().equals("Habitaciones")) {
                Intent intent = new Intent(context, Habitaciones.class);
                context.startActivity(intent);
            }
            else if(menuOption.getTitle().equals("Información")){

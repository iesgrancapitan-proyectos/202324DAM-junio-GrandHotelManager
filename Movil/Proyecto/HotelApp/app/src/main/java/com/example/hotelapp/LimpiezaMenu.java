...
import com.example.hotelapp.Adapters.LimpiezaMenuAdapter;
import com.example.hotelapp.Adapters.MainMenuAdapter;
...
/**
 * Esta clase representa la actividad del menú de limpieza en la aplicación.
 * Extiende AppCompatActivity, lo que indica que esta es una clase de Actividad.
 */
public class LimpiezaMenu extends AppCompatActivity {
    private RecyclerView recyclerView; // RecyclerView para mostrar los elementos del menú
    private LimpiezaMenuAdapter adapter; // Adaptador para el RecyclerView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_limpieza);
        ...
        menuItems.add(new MenuOption("Habitaciones", R.drawable.habitacion));

        // Configura el RecyclerView
        recyclerView = findViewById(R.id.recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new LimpiezaMenuAdapter(menuItems, this);

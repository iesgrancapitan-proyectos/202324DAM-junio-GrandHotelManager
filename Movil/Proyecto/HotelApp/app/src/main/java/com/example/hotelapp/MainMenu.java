...
/**
 * Esta clase representa la actividad del menú principal en la aplicación.
...
public class MainMenu extends AppCompatActivity {
    ...
    private MainMenuAdapter adapter; // Adaptador para el RecyclerView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuItems.add(new MenuOption("Información", R.drawable.info));
        menuItems.add(new MenuOption("Habitaciones", R.drawable.habitacion));
        menuItems.add(new MenuOption("Reservas", R.drawable.reserva));

        // Configura el RecyclerView
        recyclerView = findViewById(R.id.recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new MainMenuAdapter(menuItems, this);
